<?php
use web\Services\TipoDocumentoService;
use Tonyprr\Exception\ValidacionException;

class Api_TipoDocumentoController extends Zend_Controller_Action
{
    ...
    public function getAction()
    {
        try {
            ...
            list($aTipoDocumento, $total) = $srvTipoDocumento->aList(1, 1);
